...
export const followSuccess = (actionId: number): ActionTypes  => ({type: "FOLLOW", actionId})
export const unfollowSuccess = (actionId: number): ActionTypes  => ({type: "UNFOLLOW", actionId})
